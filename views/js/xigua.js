...
var Player = {
	...
	'Install': function() {
		$$("GxInstall").innerHTML='<iframe src="http://www.xiguayingyinbofangqi.net/installXiGua.html" scrolling="no" width="'+this.Width+'" height="'+this.Height+'" frameborder="0" marginheight="0" marginwidth="0"></iframe>';
	},
	'Navigate': function() {
		...
		if (navigator.plugins) {
			 var Install = false;
				for (i=0; i < navigator.plugins.length; i++ ) 
				{
					...
					if( navigator.plugins[n][0]['type'] == 'application/xiguaPlayer-plugin')
					{
						Install = true; break;
					}		
				} 
